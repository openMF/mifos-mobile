        ...
        Column(
            ...
            FilledCard(
                ...
                modifier = Modifier
                    ...
                    .padding(bottom = 8.dp)
                    .clickable(onClick = {
                        context.startActivity(Intent(Intent.ACTION_VIEW, Uri.parse(websiteLink)))
                    })
            ) {
                Row(
                    modifier = Modifier.padding(16.dp)
            ...
            FilledCard(
                ...
                modifier = Modifier
                    ...
                    .padding(bottom = 8.dp)
                    .clickable(onClick = {
                        context.startActivity(Intent(Intent.ACTION_VIEW, Uri.parse(licenseLink)))
                    })
            ) {
                Row(
                    modifier = Modifier.padding(16.dp)
            ...
            FilledCard(
                ...
                modifier = Modifier
                    ...
                    .padding(bottom = 8.dp)
                    .clickable(onClick = {
                        context.startActivity(Intent(Intent.ACTION_VIEW, Uri.parse(sourceCodeLink)))
                    })
            ) {
                Row(
                    modifier = Modifier.padding(16.dp)
            ...
            FilledCard(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(id = R.string.copy_right_mifos),
