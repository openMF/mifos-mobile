...
public class QrCodeGenerator {
     ...
     * @param accountType {@link org.mifos.mobile.ui.enums.AccountType} i.e. SAVINGS or LOAN
    ...
    public static String getAccountDetailsInString(String accountNumber, String officeName,
                                                   org.mifos.mobile.ui.enums.AccountType
                                                           accountType) {
        int accountId = -1;
        if (accountType == org.mifos.mobile.ui.enums.AccountType.SAVINGS) {
            accountId = 0;
        } else if (accountType == org.mifos.mobile.ui.enums.AccountType.LOAN) {
            accountId = 1;
        }
