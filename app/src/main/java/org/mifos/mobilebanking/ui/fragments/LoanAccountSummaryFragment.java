...
public class LoanAccountSummaryFragment extends BaseFragment {
    ...
    public static LoanAccountSummaryFragment newInstance(LoanWithAssociations loanWithAssociations) {
    ...
    public void showLoanAccountsDetail(LoanWithAssociations loanWithAssociations) {
        ...
        tvInterestChargedName.setText(CurrencyUtil.formatCurrency(getActivity(), loanWithAssociations.
                getSummary().getInterestCharged()));
        tvFeesName.setText(CurrencyUtil.formatCurrency(getActivity(), loanWithAssociations.getSummary().
                getFeeChargesCharged()));
        tvPenaltiesName.setText(CurrencyUtil.formatCurrency(getActivity(), loanWithAssociations.getSummary().
                getPenaltyChargesCharged()));
        tvTotalRepaymentName.setText(CurrencyUtil.formatCurrency(getActivity(), loanWithAssociations.
                getSummary().getTotalExpectedRepayment()));
        tvTotalPaidName.setText(CurrencyUtil.formatCurrency(getActivity(), loanWithAssociations.getSummary().
                getTotalRepayment()));
        tvInterestWaivedName.setText(CurrencyUtil.formatCurrency(getActivity(), loanWithAssociations.
                getSummary().getInterestWaived()));
        tvPenaltiesWaivedName.setText(CurrencyUtil.formatCurrency(getActivity(), loanWithAssociations.
                getSummary().getPenaltyChargesWaived()));
        tvFeesWaivedName.setText(CurrencyUtil.formatCurrency(getActivity(), loanWithAssociations.getSummary()
                .getFeeChargesWaived()));
        tvOutstandingBalanceName.setText(getResources().getString(R.string.string_and_string,
                ...
                formatCurrency(getActivity(), loanWithAssociations.getSummary().getTotalOutstanding())));
