...
public class LoanAccountDetailsPresenter extends BasePresenter<LoanAccountDetailsView>{
     ...
     */
    @Inject
    protected LoanAccountDetailsPresenter(DataManager dataManager, @ActivityContext Context context) {
        super(context);
     ...
     */
    public void loadLoanAccountDetails(int loanId) {
