...
import org.mifos.selfserviceapp.presenters.LoanAccountDetailsPresenter;
import org.mifos.selfserviceapp.ui.views.LoanAccountDetailsView;
...
public class LoanAccountsDetailActivity extends BaseActivity implements LoanAccountDetailsView {

    @Inject
    LoanAccountDetailsPresenter mLoanAccountDetailsPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loan_accout_details);
        ...
        loanId = getIntent().getExtras().getInt(Constants.LOAN_ID);
