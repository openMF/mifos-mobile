...
@Serializable
data class LoanWithAssociationsResponseDto(
    val id: Int? = null,
    ...
    val repaymentSchedule: RepaymentScheduleResponseDto? = null,
    ...
    val transactions: List<TransactionResponseDto?>? = arrayListOf(),
