...
internal data class RepaymentSchedulePdfStrings(
    ...
    val generationDateLabel: String,
    val hNo: String,
    val hDays: String,
    val hDate: String,
...
internal class RepaymentScheduleHtmlGenerator(
        ...
        div(classes = "container") {
            ...
            div(classes = "footer") {
                val currentDate = kotlin.time.Clock.System.now()
                    ...
                    .date
                val dateString = "${currentDate.day} ${
                    currentDate.month.name.lowercase().replaceFirstChar { it.uppercase() }
                } ${currentDate.year}"

                p { +"${strings.generationDateLabel}: $dateString" }
            }
        }
    }
    ...
    override fun getAdditionalStyles(): String {
        ...
        h1 { color: #1976d2; font-size: 16pt; border-bottom: 2px solid #1976d2; padding-bottom: 5px; margin-bottom: 15px; }
        ...
        .footer { margin-top: 20px; text-align: center; font-size: 7pt; color: #95a5a6; border-top: 1px solid #eee; padding-top: 10px; }
        """.trimIndent()
    }
}
