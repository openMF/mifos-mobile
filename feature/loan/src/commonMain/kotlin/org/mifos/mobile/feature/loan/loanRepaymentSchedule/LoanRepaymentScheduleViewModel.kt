...
internal class LoanRepaymentScheduleViewModel(
    ...
    initialState = LoanRepaymentScheduleState(dialogState = null),
) {
    init {
        val initialLoanId = savedStateHandle.getStateFlow<Long?>(Constants.LOAN_ID, initialValue = null)
        updateState {
            it.copy(loanId = initialLoanId.value)
        }
